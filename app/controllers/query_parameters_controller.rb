class QueryParametersController < ApplicationController
  def create
    resource = Resource.find(params[:query_parameter][:resource_id])
    ...
    respond_to do |format|
      if end_point.save
        format.turbo_stream do
          render turbo_stream: [
            turbo_stream.update("new-query-parameter-form", partial: "query_parameters/form", locals: { resource: resource, query_parameter: QueryParameter.new}),
        ...
        format.turbo_stream do
          render turbo_stream: [
            turbo_stream.update("new-query-parameter-form", partial: "query_parameters/form", locals: { query_parameter: @query_parameter }),
  ...
  def query_parameter_params
    params.require(:query_parameter).permit(:name, :description, :default, :type, :optional, :valid_values)
  end
end
